...
const projects = [
  ...
  },
  {
    ...
    },
    {
      ...
      description:
        '124M parameter language model trained from scratch on 2B tokens. Built every layer manually in PyTorchno Trainer.train(). Validation perplexity 14.8, trained in 5 hours. Live API, weights, and code available.',
